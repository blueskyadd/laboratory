...
module.exports = {
    ...
    sms_code: winchaingroupApi + 'user/apps/sms_code/',//发送短信验证码
    change_pwd: winchaingroupApi + 'user/apps/change_pwd/',//修改密码
   ...
   getVistitList: winchaingroupApi + 'user/apps/visit/',// 访问者
    ...
    getOrderDetail: winchaingroupApi + 'good/apps/course/',  //适应详情
