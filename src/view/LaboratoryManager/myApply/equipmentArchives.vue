<template>
    <div class="management_equipmentArchives body_main">
        ...
        <el-table :data="tableData" :cell-style="changecolor" height="calc(100%  - 1.5rem)"  style="width: 100%"  :row-class-name="tabRowClassName">
            ...
            <el-table-column prop="name" label="所属实验室" header-align='center' align='center'> </el-table-column>
            ...
            <el-table-column prop="name" label="操作" header-align='center' align='center'>
                <template><span class="underline" @click="goEquipmentDetail">查看</span></template>
            </el-table-column>
        </el-table>
    </div>
</template>
