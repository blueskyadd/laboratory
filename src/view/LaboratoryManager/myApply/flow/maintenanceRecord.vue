<template>
    <div class="LaboratoryMaintenanceRecord body_main">
        <header class="LaboratoryMaintenanceRecord_index_header">
            <h3>维修记录</h3>
...
export default {
    ...
    methods:{
        ...
        allocation(data){
            this.$router.push({path: '/LaboratoryManager/LaboratoryMaintenanceProcess',query:{maintenanceProcessID:data.row.id} })
        },
        /**@name 分页 */
...
<style lang="scss">
.LaboratoryMaintenanceRecord{
    @import '../../../../style/LabManager/management/index.scss';
     padding-top: .42rem;
     overflow-y: scroll;
    .LaboratoryMaintenanceRecord_index_header{
        padding-left: .41rem;
        height: .38rem;
        display: flex;
        margin-left: .19rem;
...
.LaboratoryMaintenanceRecord::-webkit-scrollbar{
    display: none;
}
</style>