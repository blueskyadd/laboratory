<template>
    <div class="LaboratoryMaintenanceProcess body_main">
        ...
        <div class="main">
            <div class="main_list">
                <ul>
                    <li><img src="../../../../assets/img/LabManager/management/equipment/purchase.gif" alt=""><span>故障现象</span></li>
                    ...
                    <li><img src="../../../../assets/img/LabManager/management/equipment/arrows.png" alt=""></li>
                    <li><img src="../../../../assets/img/LabManager/management/equipment/purchase.gif" alt=""><span>查看维修报告</span></li>
                </ul>
            </div>
        </div>
    </div>
