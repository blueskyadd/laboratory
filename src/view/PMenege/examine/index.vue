<template>
    <div class="management_examine body_main">
        ...
        <el-table :data="tableData" :cell-style="changecolor" height="calc(100%  - 1.5rem)"  style="width: 100%"  :row-class-name="tabRowClassName">
            <el-table-column prop="date" label="主题"  header-align='center'  align='center'> </el-table-column>
            ...
            <el-table-column prop="name" label="申请日期" header-align='center' align='center'> </el-table-column>
...
export default {
    ...
    methods:{
        ...
        goEquipmentDetail(){
            this.$router.push({name:'examineDeatil'})
        }
    }
}
</script>
