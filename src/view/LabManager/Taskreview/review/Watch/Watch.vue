<template>
    <div class="Taskreview_Watch">
        <el-table :data="tableData" :cell-style="changecolor"   style="width: 100%"  :row-class-name="tabRowClassName">
            <el-table-column prop="date"  label="工号"  header-align='center'  align='center'> </el-table-column>
            <el-table-column prop="date"  label="姓名" header-align='center'  align='center'> </el-table-column>
...
export default {
    ...
    methods:{
        ...
        /**@name 页面跳转 */
        allocation(data){
            this.$router.push({name: 'applicationWatch' })
        }
    }
}
</script>
