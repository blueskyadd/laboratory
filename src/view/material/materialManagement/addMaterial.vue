<template>
    <div class="addMaterial body_main">
        ...
        <div class="main">
            <div class="measure_main">
                <div class="mian_text first_child">
                    ...
                    <span class="margin_right">物料编号：</span>
                    <input type="text" placeholder="填写物料编号">
                </div>
                <div class="mian_text first_child">
                    <span>物料数量：</span>
                    <input type="text" placeholder="填写物料数量">
                    <span class="margin_right">物料种类：</span>
                    <el-select v-model="principal"  popper-class='principal_element' placeholder="选择物料种类">
                        <el-option
                ...
                <div class="mian_text first_child">
                    <span>物料安全库存数：</span>
                    <input type="text" placeholder="填写物料安全库存数">
                    <span class="margin_right">物料位置：</span>
                    <input type="text" placeholder="填写物料位置">
                </div>
                <div class="mian_text first_child">
                    <span>物料单位：</span>
                    <input type="text" placeholder="填写物料单位">
                    <span class="margin_right">物料周期：</span>
                    <input type="text" placeholder="填写物料周期">
                </div>
                <div class="main_list updata">
                    <span class="file_title">物料数据手册：</span>
                    <div class="file_box">
