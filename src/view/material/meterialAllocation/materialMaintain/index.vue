<template>
    <div class="management_materialMaintain">
        <div>
            ...
            <el-table-column prop="date" min-width="25%" label="设备编号"  header-align='center'  align='center'> </el-table-column>
            ...
            <el-table-column prop="name" min-width="25%"  label="负责人" header-align='center' align='center'> </el-table-column>
...
export default {
    ...
    methods:{
        ...
        /**@name 页面跳转 */
        goAllocation(data){
            this.$router.push({name: 'allocationMaintain'})
        },
        /**@name 分页 */
